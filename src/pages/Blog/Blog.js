...
export class Blog extends Component {
  ...
  mediumURL =
    "https://api.rss2json.com/v1/api.json?rss_url=https://medium.com/feed/@kavindahgm";
  ...
  render() {
    ...
    return (
      <div className="container mt-5 ">
        <br/>
        <div className="mt-5 d-flex justify-content-around row justify-center align-center items-center  ">
          {post}
        </div>
        <br/>
        <br/>
